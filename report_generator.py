...
def generate_executive_report(
    ...
    try:
        ...
        user_prompt = (
            ...
            f"ESTA SECCION ES OBLIGATORIA. Exactamente 3 parrafos de tamano mediano. "
            f"Sin bullets, sin subtitulos, sin numeracion. "
            f"Prosa corporativa, voz activa, gramatica impecable, nivel CEO/CFO/inversor. "
            f"Esta seccion es de CONCLUSIONES e INSIGHTS — no de analisis ni descripcion de KPIs. "
            f"Los datos del CONTEXTO PRECOMPUTADO son tu insumo de referencia, "
            f"no el contenido del texto. No los listes ni los describas uno a uno.\n\n"
            f"PARRAFO 1 — Conclusion sobre liquidez estructural: "
            f"sintetiza en que medida la estructura de liquidez del prestador refleja el problema "
            f"clasico del sector (cartera atrapada en el ciclo EPS), si el DSO lo posiciona como "
            f"candidato natural a instrumentos de optimizacion de cartera, y cual es la conclusion "
            f"sobre su capacidad para sostener la operacion con el capital de trabajo disponible.\n\n"
            f"PARRAFO 2 — Conclusion sobre apalancamiento y capacidad crediticia: "
            f"sintetiza si la estructura de deuda actual permite o restringe la adopcion de un "
            f"instrumento de factoring, que tan cerca o lejos esta el prestador de su limite "
            f"crediticio, y si los buenos desenlaces clinicos pueden funcionar como palanca "
            f"de elegibilidad en una oferta estructurada.\n\n"
            f"PARRAFO 3 — Calificacion y postura final: "
            f"concluye con la calificacion de candidato (CANDIDATO PRIORITARIO / MODERADO / "
            f"CON RESTRICCIONES / NO RECOMENDADO) con 2-3 lineas de justificacion, "
            f"la proyeccion de necesidad de liquidez para el proximo ejercicio, "
            f"y la postura de gestion (Favorable / Neutral / Precaucion) "
            f"con la condicion especifica que podria modificarla. "
            f"Si Aging mayor de 120d o Glosa Rate no estan disponibles, mencionalo en una frase.\n\n"
            f"REGLAS GENERALES:\n"
